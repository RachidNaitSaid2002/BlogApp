    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/signup" className="bg-white text-black px-5 py-2 rounded-full text-sm font-semibold hover:bg-white/90 transition-colors cursor-pointer">
            Let's Summarize
          </Link>
        </div>
